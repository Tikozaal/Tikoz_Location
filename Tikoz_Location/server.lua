...
RegisterNetEvent('Tikoz:LocCrossMoto')
AddEventHandler('Tikoz:LocCrossMoto', function()
...
RegisterNetEvent('Tikoz:LocCrossMotoDeux')
AddEventHandler('Tikoz:LocCrossMotoDeux', function()
